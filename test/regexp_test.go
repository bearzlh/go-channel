...
func TestCookie(t *testing.T)  {
	msg := `OS:Android UA:Mozilla/5.0 (Linux; Android 6.0.1; OPPO R9s Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 MQQBrowser/6.2 TBS/044506 Mobile Safari/537.36 MMWEBID/1091 MicroMessenger/7.0.3.1400(0x2700033B) Process/tools NetType/WIFI Language/zh_CN NetType:4G IP:117.179.11.226 [中国|0|黑龙江省|哈尔滨市|移动] user_id:1 openid:oPUdp1H58SW4taFN3fzR8mu4A-d8 channel_id:2 agent_id:3 referral_id:4 REMOTE_ADDR:10.250.2.8 HTTP_X_FORWARDED_FOR:117.179.11.226`
	regex := `.*? NetType:(\w+) IP:.*? \[(.*?)\|0\|(.*?)\|(.*?)\|(.*?)\] user_id:(\d+)* openid:(.*?) channel_id:(\d+)* agent_id:(\d+)* referral_id:(\d+)*`
...
func TestCookie1(t *testing.T)  {
	msg := `OS:Other UA:Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3638.400 QQBrowser/10.4.3264.400 NetType:Other IP:223.74.237.155 [中国|0|广东省|揭阳市|移动] admin_id: group: REMOTE_ADDR:10.250.2.7 HTTP_X_FORWARDED_FOR:223.74.237.155`
